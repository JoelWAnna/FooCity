...
public class Tile
{
	...
	public void resetMetrics(){
		...
		metricsActual[Tile.METRIC_POLLUTION] = 0;
		metricsActual[Tile.METRIC_CRIME] = 0;
		metricsActual[Tile.METRIC_HAPPINESS] = 0;
	}
	...
	private void setValues(){
		...
		case MapGridConstants.RESIDENTIAL_TILE:
			...
			price = 250;
			metricsContributed[Tile.METRIC_HAPPINESS] = 0;
			jobs = -100;
			metricsContributed[Tile.METRIC_POLLUTION] = 0;
			metricsContributed[Tile.METRIC_CRIME] = 1;
			powerConsumed = 30;
			waterConsumed = 15;
			break;
		case MapGridConstants.INDUSTRIAL_TILE:
			...
			price = 450;
			metricsContributed[Tile.METRIC_HAPPINESS] = -5;
			jobs = 75;
			metricsContributed[Tile.METRIC_POLLUTION] = 7;
			metricsContributed[Tile.METRIC_CRIME] = 7;
			powerConsumed = 75;
			waterConsumed = 35;
			break;
		case MapGridConstants.COMMERCIAL_TILE:
			...
			price = 350;
			metricsContributed[Tile.METRIC_HAPPINESS] = 2;
			jobs = 35;
			metricsContributed[Tile.METRIC_POLLUTION] = 2;
			metricsContributed[Tile.METRIC_CRIME] = 3;
			powerConsumed = 35;
			waterConsumed = 25;
			break;
		case MapGridConstants.DIRT_TILE:
			...
			jobs = 0;
			metricsContributed[Tile.METRIC_POLLUTION] = 0;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = 0;
			waterConsumed = 0;
			break;
		case MapGridConstants.PARK_TILE:
			...
			price = 100;
			metricsContributed[Tile.METRIC_HAPPINESS] = 8;
			jobs = 0;
			metricsContributed[Tile.METRIC_POLLUTION] = -3;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = 10;
			waterConsumed = 5;
			break;
		case MapGridConstants.WATER_TILE:
			...
			replaceable = false;
			price = 0;
			metricsContributed[Tile.METRIC_HAPPINESS] = 10;
			jobs = 0;
			metricsContributed[Tile.METRIC_POLLUTION] = 0;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = 0;
		...
		case MapGridConstants.FORREST_TILE:
			...
			price = 200;
			metricsContributed[Tile.METRIC_HAPPINESS] = 4;
			jobs = 0;
			metricsContributed[Tile.METRIC_POLLUTION] = -5;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = 0;
			waterConsumed = 0;
			break;
		...
		case MapGridConstants.POLICE_TILE:
			...
			jobs = 15;
			metricsContributed[Tile.METRIC_POLLUTION] = 0;
			metricsContributed[Tile.METRIC_CRIME] = -10;
			powerConsumed = 15;
			waterConsumed = 10;
			break;
		...
		case MapGridConstants.COAL_TILE:
			...
			metricsContributed[Tile.METRIC_HAPPINESS] = -10;
			jobs = 50;
			metricsContributed[Tile.METRIC_POLLUTION] = 10;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = -5000;
			waterConsumed = 25;
			break;
		case MapGridConstants.WIND_TILE:
			...
			price = 2500;
			metricsContributed[Tile.METRIC_HAPPINESS] = -3;
			jobs = 20;
			metricsContributed[Tile.METRIC_POLLUTION] = 0;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = -1000;
		...
		case MapGridConstants.ROAD_TILE:
			...
			metricsContributed[Tile.METRIC_HAPPINESS] = 0;
			jobs = 0;
			metricsContributed[Tile.METRIC_POLLUTION] = 1;
			metricsContributed[Tile.METRIC_CRIME] = 0;
			powerConsumed = 0;
			waterConsumed = 0;
			break;
